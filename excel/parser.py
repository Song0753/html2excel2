...
from html2excel2.base.parser import Parser
...
class ExcelParser(Parser):
    ...
    def html_size_count(self):
        html_data = self._read_file()
        ...
        return list((num_rows, num_cols))

    def create_empty_matrix(self):
        lst = self.html_size_count()
        row_no, col_no = lst[0], lst[1]
        matrix = np.empty((row_no, col_no), dtype=object)
        return matrix
